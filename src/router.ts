...
import routeDelImage from "./routes/assets/delImage";
...
import routeGenerateNovel from "./routes/novel/generateNovel";
import routeChatNovel from "./routes/novel/chatNovel";
...
import routeGenerateOutline from "./routes/outline/generateOutline";
import routeChatOutline from "./routes/outline/chatOutline";
...
import routeGetAssetContext from "./routes/assets/getAssetContext";
import routeGenerateScriptStream from "./routes/script/generateScriptStream";
import routeChatScript from "./routes/script/chatScript";
...
import regenFrameImageRoute from "./routes/storyboard/regenFrameImage";
import planShotsRoute from "./routes/storyboard/planShots";
import addShotRoute from "./routes/storyboard/addShot";
import getShotRefImagesRoute from "./routes/storyboard/getShotRefImages";
import deleteStoryboardImageRoute from "./routes/storyboard/deleteStoryboardImage";
import removeAssetRefImageRoute from "./routes/storyboard/removeAssetRefImage";
import getVideoPromptTipsRoute from "./routes/storyboard/getVideoPromptTips";
import getImagePromptTipsRoute from "./routes/storyboard/getImagePromptTips";
...
import routeMergeVideos from "./routes/video/mergeVideos";
import routeWorkflowGetStudioData from "./routes/workflow/getStudioData";
import routeWorkflowGetWorkflow from "./routes/workflow/getWorkflow";
import routeWorkflowSaveWorkflow from "./routes/workflow/saveWorkflow";
import routeWorkflowCreateFromTemplate from "./routes/workflow/createFromTemplate";
import routeWorkflowCopyWorkflow from "./routes/workflow/copyWorkflow";
import routeWorkflowDeleteWorkflow from "./routes/workflow/deleteWorkflow";
import routeWorkflowRunWorkflow from "./routes/workflow/runWorkflow";

export default async (app: Express) => {
  app.use("/assets/addAssets", route1);
  app.use("/assets/delAssets", route2);
  app.use("/assets/delImage", routeDelImage);
  app.use("/assets/getAssetContext", routeGetAssetContext);
  ...
  app.use("/novel/generateNovel", routeGenerateNovel);
  app.use("/novel/chatNovel", routeChatNovel);
  ...
  app.use("/outline/generateOutline", routeGenerateOutline);
  app.use("/outline/chatOutline", routeChatOutline);
  ...
  app.use("/script/generateScriptStream", routeGenerateScriptStream);
  app.use("/script/chatScript", routeChatScript);
  ...
  app.use("/storyboard/regenFrameImage", regenFrameImageRoute);
  app.use("/storyboard/planShots", planShotsRoute);
  app.use("/storyboard/addShot", addShotRoute);
  app.use("/storyboard/getShotRefImages", getShotRefImagesRoute);
  app.use("/storyboard/deleteStoryboardImage", deleteStoryboardImageRoute);
  app.use("/storyboard/removeAssetRefImage", removeAssetRefImageRoute);
  app.use("/storyboard/getVideoPromptTips", getVideoPromptTipsRoute);
  app.use("/storyboard/getImagePromptTips", getImagePromptTipsRoute);
  ...
  app.use("/video/mergeVideos", routeMergeVideos);
  app.use("/workflow/getStudioData", routeWorkflowGetStudioData);
  app.use("/workflow/getWorkflow", routeWorkflowGetWorkflow);
  app.use("/workflow/saveWorkflow", routeWorkflowSaveWorkflow);
  app.use("/workflow/createFromTemplate", routeWorkflowCreateFromTemplate);
  app.use("/workflow/copyWorkflow", routeWorkflowCopyWorkflow);
  app.use("/workflow/deleteWorkflow", routeWorkflowDeleteWorkflow);
  app.use("/workflow/runWorkflow", routeWorkflowRunWorkflow);
}
