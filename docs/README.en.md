<p>
  <a href="https://github.com/HBAI-Ltd/GalaxyLoom-app">
    <img src="https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white" alt="GitHub" />
  </a>
  &nbsp;|&nbsp;
  <a href="https://gitee.com/HBAI-Ltd/GalaxyLoom-app">
...
<img src="./logo.png" alt="GalaxyLoom Logo" height="120"/>
...
# GalaxyLoom
  ...
  <p align="center">
    <a href="https://github.com/HBAI-Ltd/GalaxyLoom-app/stargazers">
      <img src="https://img.shields.io/github/stars/HBAI-Ltd/GalaxyLoom-app?style=for-the-badge&logo=github" alt="Stars Badge" />
    </a>
    ...
    <a href="https://github.com/HBAI-Ltd/GalaxyLoom-app/releases">
      <img alt="release" src="https://img.shields.io/github/v/release/HBAI-Ltd/GalaxyLoom-app?style=for-the-badge" />
    </a>
  </p>
...
GalaxyLoom is an AI tool that leverages AI technology to automatically turn novels into scripts, then uses AI to generate images and videos for efficient short drama production. With GalaxyLoom, you can easily accomplish the entire workflow from text to visuals, making short drama creation more intelligent and convenient.
...
[![GalaxyLoom 8-minute Quick Start AI Video](./videoCover.png)](https://www.bilibili.com/video/BV1na6wB6Ea2)

**GalaxyLoom 8-Minute Quick Start AI Video**
...
| :--------------: | :---------------------------------------------------------- | :-------------------------------------------------------- | :---------------------------------------------------------- |
| Windows          | [Release](https://github.com/HBAI-Ltd/GalaxyLoom-app/releases) | [123YunPan](https://www.123865.com/s/bkn5Vv-E67cv)        | Official release installation package                       |
...
```bash
cd /opt
git clone https://github.com/HBAI-Ltd/GalaxyLoom-app.git
cd GalaxyLoom-app
yarn install
yarn build
```
...
```bash
cd /opt
git clone https://gitee.com/HBAI-Ltd/GalaxyLoom-app.git
cd GalaxyLoom-app
yarn install
yarn build
```
...
pm2 logs galaxyloom-app # View logs
...
- **GitHub**: [GalaxyLoom-web](https://github.com/HBAI-Ltd/GalaxyLoom-web)
- **Gitee**: [GalaxyLoom-web](https://gitee.com/HBAI-Ltd/GalaxyLoom-web)
...
| ----------------- | ------------------------------------- | -------------------------------------------------- | ------------------------------------------------ |
| **GalaxyLoom-app**  | Full client (this repo, for users)    | [GitHub](https://github.com/HBAI-Ltd/GalaxyLoom-app) | [Gitee](https://gitee.com/HBAI-Ltd/GalaxyLoom-app) |
| **GalaxyLoom-web**  | Frontend source (for devs)            | [GitHub](https://github.com/HBAI-Ltd/GalaxyLoom-web) | [Gitee](https://gitee.com/HBAI-Ltd/GalaxyLoom-web) |

> 💡 **Tip**: If you just want to use GalaxyLoom, download the client from this repo. The web repo is only for frontend customization/development.
